...
namespace KaisaKaavio
{
    public class Asetukset
    {
        ...
        /// </summary>
        public static readonly int HuolellisenHaunPelaajamaara = 7; // Max 7 !!!
        ...
        /// <summary>
        /// Tämä asetus määrää, montako pelaajaa enintään saa olla mukana ennen kuin sallitaan hakijan yli hyppääminen
        /// </summary>
        public static readonly int MaxPelaajiaJottaSaaHyppiaHakijanYli = 6;
        ...
        public class KisaOletusasetukset
        {
            ...
            [XmlAttribute]
            public ArvonnanAika ToinenArvonta { get; set; } = ArvonnanAika.PuoliTuntiaEnnen;

            [XmlAttribute]
            public IlmoittautumisenAlkaminen IlmoittautuminenAlkaa { get; set; } = IlmoittautumisenAlkaminen.Nyt;

            [XmlAttribute]
            public IlmoittautumisenPaattyminen IlmoittautuminenPaattyy { get; set; } = IlmoittautumisenPaattyminen.KaksiOsainenArvonta;
        }
